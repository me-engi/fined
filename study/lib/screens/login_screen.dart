      ...
      body: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              Color.fromARGB(255, 21, 17, 236),
              Color.fromARGB(255, 80, 142, 223),
              Color.fromARGB(255, 53, 105, 165)
            ]
          )
        ),
        child: Column(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  FadeInUp(duration: Duration(milliseconds: 1000), child: Text("Welcome Back!", style: TextStyle(color: Colors.white, fontSize: 30),)),
                  SizedBox(height: 10,),
                  FadeInUp(duration: Duration(milliseconds: 1300), child: Text("Log into your account", style: TextStyle(color: Colors.white, fontSize: 15),)),
                ],
              ),
            ),
            SizedBox(height: 50),
